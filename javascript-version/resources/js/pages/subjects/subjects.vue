<template>
  <div>
    ...
    <div v-else>
      ...
      <VCard>
        <!-- Datatable -->
        <VDataTable :headers="headers" :items="subjects" :items-per-page="5" class="text-no-wrap">
          <!-- Name -->
        ...
        <VCardText>
          <VContainer>
            <VRow>
              <!-- name -->
              <VCol cols="12">
                <VTextField prepend-inner-icon="ri-artboard-line" v-model="editedItem.Name" label="Subject Name" />
              </VCol>
            </VRow>
          </VContainer>
        </VCardText>
